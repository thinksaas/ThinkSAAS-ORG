...
function tag(){
	...
	echo '<div class="card">';
	echo '<div class="card-header">Hot tags<small class="float-right">';
    if($tag=='topic'){
        echo '<a class="text-black-50" href="'.tsUrl('group','tags').'">More</a>';
    }elseif($tag=='article'){
        echo '<a class="text-black-50" href="'.tsUrl('article','tags').'">More</a>';
    }
	echo '</small></div>';
